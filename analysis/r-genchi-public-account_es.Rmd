...
```{r 3_cleaning2_regular_expressions_2020_2019}
speech_2020 <- speech_2020 %>%
  str_replace_all("\n", " ") %>% # Replace "\n" by space
  str_remove_all("“") %>% str_remove_all("”") %>% # Remove "" 
...
```{r 3_cleaning2_first_frequencies_2020_2019}
...
```{r 3_cleaning2_second_frequencies_2020_2019, message=FALSE}
...
```{r 3_cleaning3_regular_expressions_2019_2018}
speech_2019 <- speech_2019 %>% 
  str_replace_all("\n", " ") %>% # Replace "\n" by space
...
```{r 3_cleaning3_first_frequencies_2019_2018}
...
```{r 3_cleaning3_second_frequencies_2019_2018, message=FALSE}
...
```{r 3_cleaning4_regular_expressions_2018_2017}
speech_2018 <- speech_2018 %>% 
  str_replace_all("\n", " ") %>% # Replace "\n" by space
...
```{r 3_cleaning4_additional_corrections}
speech_2018 <- speech_2018 %>% 
  str_remove_all("N°") %>% 
...
```{r 3_cleaning4_first_frequencies_2018_2017}
...
```{r 3_cleaning4_second_frequencies_2018_2017, message=FALSE}
...
```{r 4_one-word_analysis_frequencies_fig, include=FALSE}
...
Por último, vemos que el término *covid* se tomó la atención del discurso 2020, lo cual tiene mucho sentido en atención a la emergencia *sanitaria* de *pandemia* que comenzó en dicho año.  En este contexto, se implementaron *visitas* virtuales con programación previa y el acceso a teléfonos públicos para que los internos mantengan contacto con sus familiares.  Por otro lado, también se puso atención a la gran cantidad de detenidos que eran recibidos con *lesiones* evidentes desde las instituciones policiales, para lo cual se aprobaron protocolos de constatación de estado de salud.
